...
contract EShare is ERC20Burnable, Operator {
    using SafeMath for uint256;

    // TOTAL MAX SUPPLY = 70,000 eSHARE
    ...
    uint256 public constant DEV_FUND_POOL_ALLOCATION = 4990 ether;
    ...
    constructor(uint256 _startTime, address _devFund) public ERC20("ESHARE Test Token", "ETSHARES") {
        _mint(msg.sender, 10 ether); // mint 1 BOMB Share for initial pools deployment
