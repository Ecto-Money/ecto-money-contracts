...
contract Masonry is ShareWrapper, ContractGuard {
    ...
    function initialize(
        ...
        rewardLockupEpochs = 1; // Lock for 3 epochs (18h) before release claimReward ECTO ON STEROIDS
    ...
    function getEctoPrice() external view returns (uint256) {
        return treasury.getEctoPrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            ecto.safeTransfer(msg.sender, reward);
    ...
    function allocateSeigniorage(uint256 amount) external onlyOneBlock onlyOperator {
        ...
        ecto.safeTransferFrom(msg.sender, address(this), amount);
